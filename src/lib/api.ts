...
// 회원가입
export const postRegister = (bodyData: interfaces.IRegisterFormProps) => fetch(`${BASE_URL}/users/register`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(bodyData) }).then((res) => res.json());
